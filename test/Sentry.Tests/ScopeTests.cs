...
namespace Sentry.Tests
{
    public class ScopeTests
    {
        ...
        public void TransactionName_TransactionStarted_NameIsSetAndOverwritten()
        {
            // Arrange
            var scope = new Scope();
            scope.Transaction = new TransactionTracer(DisabledHub.Instance, new SentryOptions(), "_", "bar");
        ...
        public void TransactionName_TransactionStarted_NameReturnsActualTransactionName()
        {
            ...
            // Act
            scope.Transaction = new TransactionTracer(DisabledHub.Instance, new SentryOptions(), "_", "foo");
        ...
        public void GetSpan_NoSpans_ReturnsTransaction()
        {
            // Arrange
            var scope = new Scope();
            var transaction = new TransactionTracer(DisabledHub.Instance, new SentryOptions(), "_", "foo");
