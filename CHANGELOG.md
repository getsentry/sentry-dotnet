...
- Consolidated TransactionContext constructors and added default values for SpanContext parameters ([#2696](https://github.com/getsentry/sentry-dotnet/pull/2696))
