...
- iOS - added a native option to set ExceptionMode preventing use of unsupported marshalling behaviour for [Native AOT] ([#3729](https://github.com/getsentry/sentry-dotnet/pull/3729))
