...
//    public static class SentryScopedExtensions
//    {
//#if NETSTANDARD2_0
//        /// <summary>
...
//        /// <param name="level">The level.</param>
//        [EditorBrowsable(EditorBrowsableState.Never)]
//        public static void AddBreadcrumb(this ISentryScoped scope,
...
//        /// <summary>
//        /// Adds a breadcrumb to the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">ISentryScoped</param>
//        /// <param name="breadcrumb">The breadcrumb.</param>
//        internal static void AddBreadcrumb(this ISentryScoped scope, Breadcrumb breadcrumb)
//        {
//            var breadcrumbs = (ConcurrentQueue<Breadcrumb>)scope.Breadcrumbs;

//            var overflow = breadcrumbs.Count - (scope.MaxBreadcrumbs
...
//        /// <summary>
//        /// Sets the fingerprint to the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">The scope.</param>
//        /// <param name="fingerprint">The fingerprint.</param>
//        public static void SetFingerprint(this ISentryScoped scope, IEnumerable<string> fingerprint)
//            => scope.Fingerprint = fingerprint;

//        /// <summary>
//        /// Sets the extra key-value to the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">The scope.</param>
//        /// <param name="key">The key.</param>
//        /// <param name="value">The value.</param>
//        public static void SetExtra(this ISentryScoped scope, string key, object value)
//            => ((ConcurrentDictionary<string, object>)scope.Extra).AddOrUpdate(key, value, (s, o) => value);

//        /// <summary>
//        /// Sets the extra key-value pairs to the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">The scope.</param>
//        /// <param name="values">The values.</param>
//        public static void SetExtras(this ISentryScoped scope, IEnumerable<KeyValuePair<string, object>> values)
//        {
...
//        /// <summary>
//        /// Sets the tag to the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">The scope.</param>
//        /// <param name="key">The key.</param>
//        /// <param name="value">The value.</param>
//        public static void SetTag(this ISentryScoped scope, string key, string value)
...
//        public static void SetTags(this ISentryScoped scope, IEnumerable<KeyValuePair<string, string>> tags)
//        {
...
//        /// <summary>
//        /// Removes a tag from the <see cref="ISentryScoped"/>
//        /// </summary>
//        /// <param name="scope">The scope.</param>
//        /// <param name="key"></param>
//        public static void UnsetTag(this ISentryScoped scope, string key)
//        {
//            if (scope.Tags is ConcurrentDictionary<string, string> tagDic)
//            {
//                tagDic.TryRemove(key, out _);
//            }
//            else
//            {
//                scope.Tags = scope.Tags?.Where(t => t.Key == key).ToDictionary(k => k.Key, v => v.Value);
//            }
//        }
...
//        ///// </remarks>
//        //public static void Apply(this ISentryScoped from, ISentryScoped to)
//        //{
...
//        //public static void Apply(this ISentryScoped scope, object state)
//        //{
//        //    switch (state)
//        //    {
