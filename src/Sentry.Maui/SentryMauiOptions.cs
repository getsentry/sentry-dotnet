...
public class SentryMauiOptions : SentryLoggingOptions
{
    ...
    private Func<SentryEvent, SentryHint, bool>? _beforeScreenshotCapture;
    /// <summary>
    /// Action performed before attaching a screenshot
    /// </summary>
    internal Func<SentryEvent, SentryHint, bool>? BeforeScreenshotCaptureInternal => _beforeScreenshotCapture;
    ...
    {
        _beforeScreenshotCapture = beforeCapture;
    }
}
