...
/// <summary>
/// Holds a range of HTTP status codes.
...
public readonly record struct HttpStatusCodeRange
{
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if start > end</exception>
    ...
    /// </summary>
    /// <param name="range">A tubble of ints to convert</param>
    ...
    /// </summary>
    /// <param name="range">A tupple of status codes to convert</param>
