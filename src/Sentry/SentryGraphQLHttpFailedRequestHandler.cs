...
internal class SentryGraphQLHttpFailedRequestHandler : ISentryFailedRequestHandler
{
    private readonly IHub _hub;
    private readonly SentryOptions _options;

    public const string MechanismType = "SentryGraphQLHttpFailedRequestHandler";
    ...
    internal static ISentryFailedRequestHandler Create(IHub hub, SentryOptions options)
        => new SentryGraphQLHttpFailedRequestHandler(hub, options);
