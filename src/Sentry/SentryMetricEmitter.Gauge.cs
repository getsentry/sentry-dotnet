...
public abstract partial class SentryMetricEmitter
{
    ...
    /// <typeparam name="T">The numeric type of the metric.</typeparam>
    /// <remarks>Supported numeric value types for <typeparamref name="T"/> are <see langword="byte"/>, <see langword="short"/>, <see langword="int"/>, <see langword="long"/>, <see langword="float"/>, and <see langword="double"/>.</remarks>
    public void EmitGauge<T>(string name, T value, MeasurementUnit unit) where T : struct
    {
        CaptureMetric(SentryMetricType.Gauge, name, value, unit.ToNullableString(), [], null);
    }
    ...
    /// <typeparam name="T">The numeric type of the metric.</typeparam>
    /// <remarks>Supported numeric value types for <typeparamref name="T"/> are <see langword="byte"/>, <see langword="short"/>, <see langword="int"/>, <see langword="long"/>, <see langword="float"/>, and <see langword="double"/>.</remarks>
    public void EmitGauge<T>(string name, T value, MeasurementUnit unit, Scope? scope) where T : struct
    {
        CaptureMetric(SentryMetricType.Gauge, name, value, unit.ToNullableString(), [], scope);
    }
    ...
    /// <typeparam name="T">The numeric type of the metric.</typeparam>
    /// <remarks>Supported numeric value types for <typeparamref name="T"/> are <see langword="byte"/>, <see langword="short"/>, <see langword="int"/>, <see langword="long"/>, <see langword="float"/>, and <see langword="double"/>.</remarks>
    public void EmitGauge<T>(string name, T value, MeasurementUnit unit, IEnumerable<KeyValuePair<string, object>>? attributes, Scope? scope = null) where T : struct
    {
    ...
    /// <typeparam name="T">The numeric type of the metric.</typeparam>
    /// <remarks>Supported numeric value types for <typeparamref name="T"/> are <see langword="byte"/>, <see langword="short"/>, <see langword="int"/>, <see langword="long"/>, <see langword="float"/>, and <see langword="double"/>.</remarks>
    public void EmitGauge<T>(string name, T value, MeasurementUnit unit, ReadOnlySpan<KeyValuePair<string, object>> attributes, Scope? scope = null) where T : struct
    {
        CaptureMetric(SentryMetricType.Gauge, name, value, unit.ToNullableString(), attributes, scope);
    }
}
