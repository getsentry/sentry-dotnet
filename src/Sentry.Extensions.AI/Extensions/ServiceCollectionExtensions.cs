...
public static class SentryAIExtensions
{
    ...
    //         var hub = inner.GetService<IHub>() ?? HubAdapter.Instance;
    ...
    /// </summary>
    public static IChatClient WithSentry(this IChatClient client, string? agentName = null, string? system = null)
    {
        return new SentryChatClient(client, HubAdapter.Instance, agentName, system);
    }
}
