...
// TODO: Remove this copy in favor of InternalsVisibleTo
/*
 * This is a Copy of an internal class from Sentry package.
 * In order to access internals from that assembly, friendly assembly is needed.
 * BenchmarkDotNet is failing to build its generated projects by not finding the snk
 * https://github.com/dotnet/BenchmarkDotNet/issues/836
 *
 * This copy will likely go out of sync eventually, the goal is to delete this
 * and have the benchmark on the internals once a fix or work around is found
 */
